...
export default function BackOffice() {
  const { employees, fetchEmployees, isLoading, error } = useFetchEmployees();
  const [localEmployees, setLocalEmployees] = useState([]);
  const [form, setForm] = useState({ name: "", position: "", image: null });
  const [editId, setEditId] = useState(null);

  // Initialize localEmployees from hook once
  React.useEffect(() => {
